...
| [`Organika/sdxl-detector`](https://huggingface.co/Organika/sdxl-detector) | CC BY-NC 3.0 | **Prohibited** |
...
Two of the five forbid commercial use outright, so **running this tool as
configured is a personal, non-commercial activity** regardless of the
permissive license on the code. A permissive grant on a wrapper cannot widen
the terms of what it wraps.

If you need a commercially usable build, you would have to drop EditLens and
the Organika image detector and re-check the terms of whatever replaces them.
